...
import plsql.repository.sp.FnTestOutSP;
...
public class FnTestOutDAOTest {

    @InjectMocks
    FnTestOutDAOImpl repository;

    @Mock(name = "FnTestOutSP")
    private FnTestOutSP function;

    @Test
    public void testFnTestOutDAOExecute() throws java.sql.SQLException {
        FnTestOutOUT out;
    ...
    public void testExecuteFnTestOutDAOError() throws java.sql.SQLException {
