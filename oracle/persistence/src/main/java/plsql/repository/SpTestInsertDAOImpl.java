...
public final class SpTestInsertDAOImpl
        implements SpTestInsertDAO {
     ...
     */
    @Override
    public SpTestInsertOUT execute(
            final SpTestInsertIN params
    ) throws SQLException {
        ...
        SpTestInsertOUT result;
        result = new SpTestInsertOUT();
